            ...
            <div className="flex-1 max-w-lg">
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-2 rounded-full border border-gray-300 focus:ring-2 focus:ring-indigo-400 focus:border-indigo-400 outline-none text-gray-700"
                />
              </div>
            </div>
        ...
        <div className="p-4 space-y-4">
          ...
          <div>
            ...
            <ul className="space-y-1 text-gray-700">
              ...
              <li><input type="checkbox" /> Toys</li>
            </ul>
          </div>
