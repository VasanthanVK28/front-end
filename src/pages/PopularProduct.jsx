      ...
      <div className="max-w-6xl mx-auto p-6 md:p-10 bg-white shadow-md rounded-2xl mt-10">
        <div className="flex flex-col md:flex-row gap-10">
          ...
          <div className="flex-1 space-y-4">
            ...
            {/* 🟡 Add to Cart Button */}
            <button className="inline-block mt-4 bg-gradient-to-r from-indigo-600 to-purple-600 text-white px-6 py-2 rounded-full font-semibold shadow-md hover:shadow-lg hover:scale-105 transition-all duration-300">
              Buy Now
            </button>
          </div>
        </div>
      ...
      <footer className="w-full bg-gray-900 text-gray-300 mt-20">
        ...
        <div className="w-full border-t border-gray-700 py-4 text-center text-sm">
          <p>
            ...
            <span className="text-yellow-400 font-semibold">TrendyMart</span>.
            All rights reserved.
          </p>
        </div>
      </footer>
