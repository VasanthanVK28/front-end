    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="p-10 max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6">
          {[
            { name: "Laptops", key: "laptop", img: "https://tse2.mm.bing.net/th/id/OIP.jw-hh-7JWvedyEv-2qekaQHaE3?rs=1&pid=ImgDetMain&o=7&rm=3" },
            { name: "Mobiles", key: "mobile", img: "https://m.media-amazon.com/images/I/81vxWpPpgNL.jpg" },
            { name: "Sofas", key: "sofa", img: "https://tse2.mm.bing.net/th/id/OIP.crPBzWUg_xYrh5D_EtBsnwHaHa?w=626&h=626&rs=1&pid=ImgDetMain&o=7&rm=3" },
            { name: "Shirts", key: "shirt", img: "https://tse3.mm.bing.net/th/id/OIP.F2-POkF06gMEJzdxvvXU-AHaHl?rs=1&pid=ImgDetMain&o=7&rm=3" },
            { name: "Toys", key: "toys", img: "https://static.vecteezy.com/system/resources/previews/030/680/149/large_2x/toys-high-quality-4k-ultra-hd-hdr-free-photo.jpg" },
          ].map((c) => (
            <div
              key={c.key}
            ...
            >
              <img src={c.img} alt={c.name} className="w-full h-36 object-cover rounded-lg mb-4" />
                      ...
                      {showRating && (
                        <div className="flex items-center mt-2">
                          {Array.from({ length: 5 }, (_, i) => {
                            ...
                            if (rating >= i + 1) return <FaStar key={i} style={{ color: starColor }} />;
                            if (rating >= i + 0.5) return <FaStarHalfAlt key={i} style={{ color: starColor }} />;
                            return <FaRegStar key={i} style={{ color: starColor }} />;
                          })}
